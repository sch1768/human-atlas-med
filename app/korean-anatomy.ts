...
export const KOREAN_ANATOMY_TERMS: Record<string, KoreanTerm> = {
  ...
  'accessory nerve': { koreanName: '더부신경', hanjaName: '부신경', aliases: ['spinal accessory nerve', 'CN XI', '11th cranial nerve'] },
  ...
  'common palmar digital nerve of thumb': { koreanName: '엄지온바닥쪽손가락신경', hanjaName: '무지 총장측수지신경' },
  'common palmar digital nerves of median nerve': { koreanName: '정중신경온바닥쪽손가락신경', hanjaName: '정중신경 총장측수지신경' },
  'palmar cutaneous branch of median nerve': { koreanName: '정중신경손바닥피부가지', hanjaName: '정중신경 장측피지' },
  'proper palmar digital nerves of median nerve': { koreanName: '정중신경고유바닥쪽손가락신경', hanjaName: '정중신경 고유장측수지신경' },
  'proper palmar digital nerves of thumb': { koreanName: '엄지고유바닥쪽손가락신경', hanjaName: '무지 고유장측수지신경' },
  ...
  'great auricular nerve': { koreanName: '큰귓바퀴신경', hanjaName: '대이개신경' },
  'lesser occipital nerve': { koreanName: '작은뒤통수신경', hanjaName: '소후두신경' },
  'superficial branches of cervical plexus': { koreanName: '목신경얼기얕은가지', hanjaName: '경신경총 표재지', aliases: ["Erb's point", 'nerve point of neck'] },
  'supraclavicular nerve': { koreanName: '빗장위신경', hanjaName: '쇄골상신경' },
  'transverse cervical nerve': { koreanName: '가로목신경', hanjaName: '횡경신경' },
